...
Page({
  ...
  refresh: function (e) {
    ...
    if (self.data.openid) {
      ...
      args.avatarUrl = userInfo.avatarUrl || 'https://blogimg.lieme.cn/2023/02/20230202061843735.gif';
  ...
  goAdmin(e) {
    var href = '/pages/webpage/webpage?url=' + encodeURIComponent(e.currentTarget.dataset.url);
    wx.navigateTo({
      url: href
    })
  },

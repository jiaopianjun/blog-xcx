...
Page({
  ...
  onPageScroll: function (e) {
    console.log("页面滚动，距离顶部：" + e.scrollTop,e.scrollTop > 160 );
    this.setData({
      isShowBar: e.scrollTop > 300 ? true : false
    })
  },
  ...
  onShareAppMessage: function () {
    return {
      title: '“' + webSiteName + '”一枚佛系前端开发，会一丢丢摄影，喜欢折腾，爱好美食。分享点前端技巧、笔记以及各种有趣的APP和资源教程♥♥',
  ...
  onShareTimeline: function () {
    return {
      title: '“' + webSiteName + '”小程序,一枚佛系前端开发，会一丢丢摄影，喜欢折腾，爱好美食。分享点前端技巧、笔记以及各种有趣的APP和资源教程♥♥',
      path: 'pages/index/index',
